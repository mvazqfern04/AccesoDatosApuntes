...
use BDEmpresa;
drop table empregado,departamento,proxecto,empregado_proxecto;

CREATE TABLE empregado (
		nombre varchar(25) NOT NULL,
        apelido_1 varchar(25) NOT NULL,
        apelida_2 varchar(25) NOT NULL,
        ...
        num_departamento_pertenece int,
        PRIMARY KEY (nss),
...
describe empregado;
describe proxecto;
describe empregado_proxecto;
describe departamento;

Comandos de consulta:
-UPDATE empregado SET nome = ?, apelido_1 = ?, apelido_2 = ?, rua = ?, numero_rua = ?, piso = ?, cp = ?, localidad = ?, data_nacemento = ?, salario = ?, sexo = ?, nss_supervisa = ?, num_departamento_pertenece = ? WHERE nss = nss(que elegimos)
-INSERT INTO proxecto num_proxecto, nume_proxecto, lugar, num_departemento values(?, ?, ?, ?)
-SELECT * FROM empregados 
SELECT * FROM departemento
